...
/**
 * \file    test/phpunit/MMIEntrepotsFunctionalTest.php
...
/**
 * Class MMIEntrepotsFunctionalTest
 *
 ...
 *
 * @package Testmmientrepots
 */
class MMIEntrepotsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIEntrepots')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIEntrepots')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmientrepots/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmientrepots/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmientrepots/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmientrepots/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmientrepotswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIEntrepots_MMIEntrepotsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIEntrepots_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
